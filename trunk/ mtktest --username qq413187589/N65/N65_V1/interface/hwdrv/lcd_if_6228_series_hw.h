 ...
 * Description:
 * ------------
 *   This file is to define LCD HW register in 6228, 6229, 6230, 6268T chips.
 *
 * Author:
 * -------
 * -------
 ...
 *
 *******************************************************************************/
#ifndef __LCD_IF_6228_SERIES_HW_H__
#define __LCD_IF_6228_SERIES_HW_H__
...
#include "drv_features.h"
   ...
   #define LCD_ROI_BG_COLOR_REG           (LCD_base+0x0068)            
   ...
   #if (defined(MT6228))
      #define LCD_COLOR_PALETTE0_ADDR     (LCD_base+0xC800)
      #define LCD_CMD_PARAMETER_ADDR      (LCD_base+0xCC00)
   ...
   #define REG_LCD_ROI_BACKGROUND_COLOR   *((volatile unsigned int *)   (LCD_base+0x0068))         
   ...
   #define LCD_WMEM_RGB565                            0
   #define LCD_WMEM_RGB888                            1
   #define LCD_ROI_WMEM_CONT_BIT                      0x0004
   #define LCD_ROI_WMEM_BUG_BIT                       0x0000
   #define LCD_ROI_WMEM_CTRL_FORMAT                   0x0002
   #define LCD_ROI_WMEM_CTRL_TO_LCM                   0x0001
   #define LCD_LAYER_MASK                             0xFC000000
   #define LCD_DC_LAYER_MASK                          0x00FC0000
   #define LCD_HW_TRIGGER_IDMA_MASK                   0x0000FC00
         
   
   #if (defined(MT6228))
      #define LCD_ROI_CTRL_CMD_NUMBER_MASK            0x00003F00
   #elif (defined(MT6229)||defined(MT6268T)||defined(MT6230))
...
/*end of serial interface control*/                                                         
   ...
   #define SET_LCD_IBW1_TRIGGER_LAYER(n)                REG_LCD_ROI_HW_CTRL &= ~LCD_HW_TRIGGER_IDMA_MASK;   
   #define SET_LCD_IBW2_TRIGGER_LAYER(n)                REG_LCD_ROI_HW_CTRL &= ~LCD_HW_TRIGGER_IDMA_MASK;\
                                                        REG_LCD_ROI_HW_CTRL |= (n>>16);            
...
#endif /* (defined(MT6228)||defined(MT6229)||defined(MT6230)||defined(MT6268T)) */

#endif //__LCD_IF_6228_SERIES_HW_H__