...
/***************************************************************************/
	...
	LCD_reg_FT1505(0x003c, 0x0601);	
	LCD_reg_FT1505(0x003d, 0x0101);
	...
	LCD_reg_FT1505(0x0012, 0x0119);	 LCD_Delayms(50);        		
	LCD_reg_FT1505(0x0013, 0x1c00);	 
	LCD_reg_FT1505(0x0029, 0x0026);	 LCD_Delayms(50); 
