...
/* For customer define the SMS TL Layer retry count */
#define MAX_SMS_TL_RETRY_COUNT  1

/* For customer define the SMS TL Layer retry timer between each retry, unit is 0.1 second */
#define SMS_TL_TIMEOUT_TICK 120

kal_uint8 sms_tl_max_retry_count (void);

kal_uint8 sms_tl_retry_timer (void);
