...
extern void tst_inject_string_hdlr (local_para_struct  *local_para_ptr,
...
extern void l4c_open_uart_port_cnf_hdlr(local_para_struct  *local_para_ptr,
                                  peer_buff_struct *peer_buff_ptr);
extern void l4c_close_uart_port_cnf_hdlr(local_para_struct  *local_para_ptr,
                                  peer_buff_struct *peer_buff_ptr);
