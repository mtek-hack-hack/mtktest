...
#error "stack_ltlcom.h should be included"
    ...
    extern kal_bool phb_sim_read(control_block_type *control_block);
    extern kal_bool phb_sim_write(control_block_type *control_block);
    extern kal_bool phb_sim_delete(control_block_type *control_block);
