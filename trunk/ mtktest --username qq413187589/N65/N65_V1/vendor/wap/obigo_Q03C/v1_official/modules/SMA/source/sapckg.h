...
typedef void        sma_pkg_handle_t;   /* This is dummy package handle type */
typedef MSF_UINT8   sma_pkg_id_t;       /* Package encapsulation internal package id */

/* Function pointer type for package handle signal */
typedef int (*sma_pckg_handle_signal_t)(
                       sma_pkg_handle_t *pkg_inst,
                       MSF_UINT16        signal,
                       void             *sig_data,
                       MSF_INT32        *id);

/* Function pointer type for package instance allocation */
typedef sma_pkg_handle_t *(*sma_pckg_init_t)(MSF_UINT8 mod_id);

/* Function pointer type for package get private data */
typedef void *(*sma_pckg_get_private_data_t)(
                       sma_pkg_handle_t *pkg_inst,
                       MSF_INT32         id);

/* Function pointer type for package get private data */
typedef int (*sma_pckg_set_private_data_t)(
                                           sma_pkg_handle_t *pkg_inst,
                                           MSF_INT32         id,
                                           void             *p);

/* Function pointer type for package terminate */
typedef int (*sma_pckg_terminate_t)(
                       sma_pkg_handle_t *pkg_inst);

/* Function pointer type for package delete */
typedef int (*sma_pckg_delete_t)(
                       sma_pkg_handle_t *pkg_inst,
                       MSF_INT32         id);

/* Function pointer type for package get result */
typedef int (*sma_pckg_get_result_t)(
                       sma_pkg_handle_t *pkg_inst, 
                       MSF_INT32         id,
                       msf_pck_result_t *result);

/* Function pointer type for package free result */
typedef int (*sma_pckg_free_result_t)(
                       sma_pkg_handle_t *pkg_inst,
                       msf_pck_result_t *result);
...
typedef struct {
    ...
    sma_pkg_handle_t       *pkg_handle;           /* package handle */
    sma_pckg_free_result_t free_fnc;              /* Free function ptr */    
    MSF_UINT8              module;                /* Module memory ref */    
} sma_pckg_result_t;


/* Function pointer type for custom user module operation response handler */
typedef int (*sma_pckg_response_handler_t)(
                       ...
                       sma_pkg_id_t         pckg_id,    /* Package registration Id */
                       sma_pkg_handle_t     *pkg_inst,  /* Package instance handle */
                       MSF_INT32            id,         /* Package operation Id */
                       sma_pckg_result_t    *result,    /* Operation result data */
                       void                 *data);     /* Private_data, (optional) */

typedef struct sma_pckg_fnc_list_t
{
    sma_pckg_init_t             init_fnc;               /* Package instance allocation */
    sma_pckg_handle_signal_t    handle_signal_fnc;      /* Handle signal function ptr */
    sma_pckg_get_private_data_t get_private_data_fnc;   /* Get private data function ptr */
    sma_pckg_set_private_data_t set_private_data_fnc;   /* Get private data function ptr */
    sma_pckg_terminate_t        terminate_fnc;          /* Terminate handle function ptr */
    sma_pckg_delete_t           delete_fnc;             /* Delete operation function ptr */
    sma_pckg_get_result_t       get_result_fnc;         /* Get result function ptr */
    sma_pckg_free_result_t      free_result_fnc;        /* Free result function ptr */
} sma_pckg_fnc_list_t;


typedef struct sma_pckg_pkg_list_t
{
    sma_pkg_id_t                pckg_id;
    const sma_pckg_fnc_list_t  *package_fncs;               /* Package function pointers */
    
    struct sma_pckg_pkg_list_t *next;
} sma_pckg_pkg_list_t;


typedef struct sma_pckg_inst_list_t
{
    sma_pckg_pkg_list_t         *pkg_data;
    sma_pkg_handle_t            *pkg_inst;
    MSF_UINT32                  active_operations;
    MSF_BOOL                    terminate_requested;
    
    struct sma_pckg_inst_list_t *next;
} sma_pckg_inst_list_t;

typedef struct
{
    MSF_UINT8                    mod_id;          /* Usage context, for memory allocation */
    sma_pkg_id_t                 pkg_count;       /* Counter for package ID */
    sma_pckg_pkg_list_t         *reg_pkg_list;    /* List of registered packages */
    sma_pckg_inst_list_t        *reg_inst_list;   /* List of registered package instances */
    MSF_BOOL                     do_free_result;  /* Shal encapsulation auto free data ? */
    
    sma_pckg_response_handler_t  reg_handler;     /* Registered internal operation handler. */
} sma_pckg_handle_t;
 ...
 */
int sma_pckg_cancel(const sma_pckg_handle_t* handle, const void* pck_inst, 
