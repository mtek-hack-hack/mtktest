...
#* Description:
#* ------------
#*   This script will gererate files based [<file name>]<file content> format
#*
#* Author:
#* -------
...
#* $Log:   //mtkvs01/vmdata/Maui_sw/archives/mcu/tools/lst2file.pl-arc  $
 #
...
my $reading = <DEF_FLIE>;
exit(0) unless ($reading =~ /\[.+\]\w+/g);

# replace all \[ with \n
$reading =~ s/\[/\n/g;

seek(DEF_FLIE,0,0);
print DEF_FLIE $reading;
close DEF_FLIE;

# re-open & generate files
open DEF_FLIE, "<$DEF_FLIE" or die "cannot open $DEF_FLIE\n";
