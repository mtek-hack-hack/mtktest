...
address_t med_ext_smalloc(size_type size)
{
    ...
    {
        ptr = kal_adm_alloc(g_med_ext_mem_cntx.ext_mem_pool_id, size);
        ...
        MED_MEM_INFO(MED_EXT_MEM_SIZE, med_ext_left_size(), size, ptr, g_med_ext_mem_cntx.ext_mem_alloc_count);
...
void med_ext_sfree(address_t ptr)
{
    ...
    if (ptr!=NULL)
    {
        ...
        g_med_ext_mem_cntx.ext_mem_alloc_count--;
        g_med_ext_mem_cntx.ext_mem_left_size = kal_adm_get_total_left_size(g_med_ext_mem_cntx.ext_mem_pool_id);
        MED_FREE_MEM_INFO(ptr, g_med_ext_mem_cntx.ext_mem_alloc_count, med_ext_left_size());
    }
}
