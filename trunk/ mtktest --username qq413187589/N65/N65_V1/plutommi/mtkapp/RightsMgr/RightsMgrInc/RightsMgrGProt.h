...
extern void mmi_drm_init(void);
extern void mmi_drm_show_process_info(S32 result, applib_mime_type_struct *type);
extern void mmi_drm_send_get_imsi_cnf(U8* imsi, S32 result);
extern void mmi_drm_activate_file(S8* filepath);
extern kal_bool mmi_rmgr_populate_drm_info(kal_wchar *path, kal_uint8 app_perm, kal_uint8 *data);
