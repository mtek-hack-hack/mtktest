...
#include "gui.h"
    ...
    extern void bytestream_initialize(bytestream *file, U8 *data, S32 size);
    extern void bytestream_fclose(bytestream *file);
    extern U8 bytestream_fseek(bytestream *file, S32 offset, S32 mode);
