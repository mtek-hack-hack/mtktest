...
* Define
*****************************************************************************/
#ifdef __MMI_GAME_MAGICSUSHI_240x320__
...
#define MMI_GX_MAGICSUSHI_BACKGROUND1_X2 (310)
...
void mmi_gx_magicsushi_draw_dynamic_background(void)
{
    ...
    gdi_draw_solid_rect(
        ...
        MMI_GX_MAGICSUSHI_TIME_POSITION_Y + 4,
        GDI_COLOR_TRANSPARENT);
    gdi_draw_solid_rect(
        position_x,
        MMI_GX_MAGICSUSHI_TIME_POSITION_Y,
    ...
    gdi_draw_solid_rect(
        ...
        position_x + MMI_GX_MAGICSUSHI_TIME_MAX_WIDTH,
        MMI_GX_MAGICSUSHI_REMAINDER_POSITION_Y + 4,
        GDI_COLOR_TRANSPARENT);
    gdi_draw_solid_rect(
        position_x,
        MMI_GX_MAGICSUSHI_REMAINDER_POSITION_Y,
...
void mmi_gx_magicsushi_render(void)
{
    ...
    if (g_gx_magicsushi_context.softkey_state == 1)
    {
        gdi_draw_solid_rect(
            ...
            MMI_GX_MAGICSUSHI_SOFTKEY_X + MMI_GX_MAGICSUSHI_SOFTKEY_WIDTH,
            MMI_GX_MAGICSUSHI_SOFTKEY_Y + MMI_GX_MAGICSUSHI_SOFTKEY_HEIGHT,
            GDI_COLOR_TRANSPARENT);
                ...
                for (j = 0; j < 8; j++)
                {
                    if (j != g_gx_magicsushi_context.i_map[i][j])
                    {
                        ...
                        gdi_draw_solid_rect(
                            x,
                            y,
                            x + MMI_GX_MAGICSUSHI_SIZE,
                            y + MMI_GX_MAGICSUSHI_SIZE,
                            GDI_COLOR_TRANSPARENT);
        ...
        case 10:
            ...
            if (g_gx_magicsushi_context.animation_step == 0)
            {
                gdi_draw_solid_rect(
                    MMI_GX_MAGICSUSHI_ORIGIN_X,
                    MMI_GX_MAGICSUSHI_ORIGIN_Y,
                    MMI_GX_MAGICSUSHI_ORIGIN_X + 232,
                    MMI_GX_MAGICSUSHI_ORIGIN_Y + 232,
                    GDI_COLOR_TRANSPARENT);
        ...
        case 11:
            ...
            if (g_gx_magicsushi_context.animation_step == 0)
            {
                gdi_draw_solid_rect(
                    MMI_GX_MAGICSUSHI_ORIGIN_X,
                    MMI_GX_MAGICSUSHI_ORIGIN_Y,
                    MMI_GX_MAGICSUSHI_ORIGIN_X + 224,
                    MMI_GX_MAGICSUSHI_ORIGIN_Y + 224,
                    GDI_COLOR_TRANSPARENT);
                mmi_gx_magicsushi_gen_map();
            }
            break;
...
void mmi_gx_magicsushi_draw_gameover(void)
{
    ...
    /* draw score */
    position_x = MMI_GX_MAGICSUSHI_GAMEOVER_SCORE_POSITION_X;
    ...
    do
    {
        ...
        gdi_image_draw_id(position_x, MMI_GX_MAGICSUSHI_GAMEOVER_SCORE_POSITION_Y, (U16) (IMG_ID_GX_MAGICSUSHI_NUMBER_0 + tmp_digit));
        position_x = position_x - MMI_GX_MAGICSUSHI_DIGIT_WIDTH;
    } while (tmp_grade > 0);
    ...
    for (i = 1; i < 7; i++)
    {
        for (j = 1; j < 7; j++)
        {
            ...
            switch (scase)
            {
                ...
                case 9:
                    if (g_gx_magicsushi_context.map[i + 1][j] == item || g_gx_magicsushi_context.map[i][j - 1] == item
                        || g_gx_magicsushi_context.map[i - 1][j] == item ||
                        g_gx_magicsushi_context.map[i][j + 1] == item)
                    {
                        return 1;
                    }
                    break;
...
#endif /* IS_MAGICSUSHI_BASE_GAME */ /* __MMI_GAME_MAGICSUSHI__ */
