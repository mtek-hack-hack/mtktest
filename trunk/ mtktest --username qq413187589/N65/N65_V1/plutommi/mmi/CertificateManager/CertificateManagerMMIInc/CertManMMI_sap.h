 ...
 * Description:
 * ------------
 *    Certificate Manager UI exported services
 *
 * Author:
 * -------
 * -------
...
/*------------ MSG_ID_MMI_CERTMAN_MSG_CODE_BEGIN ---------------*/
MSG_ID_MMI_CERTMAN_INSTALL_CERT_IND = MSG_ID_MMI_CERTMAN_MSG_CODE_BEGIN,
    ...
    MSG_ID_MMI_CERTMAN_SELECT_USER_CERT_RSP, MSG_ID_MMI_CERTMAN_MSG_CODE_END = MSG_ID_MMI_CERTMAN_SELECT_USER_CERT_RSP,
/*------------ MSG_ID_MMI_CERTMAN_MSG_CODE_END ---------------*/
