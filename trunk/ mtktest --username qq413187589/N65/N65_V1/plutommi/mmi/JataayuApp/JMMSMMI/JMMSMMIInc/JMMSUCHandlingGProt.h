 ...
 *============================================================================
 ****************************************************************************/
#ifndef __MMI_UC_JMMS_GPROT_H
#define __MMI_UC_JMMS_GPROT_H

#if defined (JATAAYU_SUPPORT) && defined (MMS_SUPPORT) && defined (__UNIFIED_COMPOSER_SUPPORT__)

extern kal_bool mmi_mms_uc_check_image_file(kal_uint8 *file);
extern kal_uint32 mmi_jmms_get_display_width(void);
extern kal_uint32 mmi_jmms_get_display_height(void);
extern kal_uint32 mma_get_mmi_file_size(const kal_wchar *filepath);
extern const char *mmi_jmms_uc_get_name_from_path(const char *filepath_p);
