...
typedef struct
{
    ...
    U8 TotalCallCount;
    U8 OldestCallIndex;
    CM_CALL_HANDLE ucm_conf_group_id;
} cm_state_struct;
...
extern void SetCCBSNumber(U8 *number);
extern PU8 GetCCBSNumber(void);
...
extern PU8 GetCallLogNumber(CM_CALL_HANDLE handle);
extern PU8 GetCallLogName(CM_CALL_HANDLE handle);
...
extern PU8 GetDispNameorNum(CM_CALL_HANDLE call_handle);
