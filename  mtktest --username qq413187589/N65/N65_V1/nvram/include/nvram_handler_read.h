 ...
 * Description:
 * ------------
 *   This is read_handler() of NVRAM module.
 *
 * Author:
 * -------
 * -------
...
#ifndef _NVRAM_HANDLER_READ_H
#define _NVRAM_HANDLER_READ_H
...
#error "kal_release.h should be included"
    ...
    extern void nvram_read_handler(ilm_struct *ilm_ptr);
