...
#ifndef _SAINTSIG_H
#error saintsig.h must be included berfore sauidia.h!
#endif
...
typedef enum
{
    SMA_DIALOG_ALERT,   /* <! Alert dialog */
    SMA_DIALOG_WARNING, /* <! Warning dialog */
    SMA_DIALOG_INFO,    /* <! Information dialog */
    SMA_DIALOG_ERROR    /* <! Error dialog */
}SmaDialogType;

/* Actions related to the confirmation dialog */
typedef enum
{
    SMA_CONFIRM_DIALOG_OK,     /* <! The End User presses ok */
    SMA_CONFIRM_DIALOG_CANCEL  /* <! The End USer presses cancel */
}SmaConfirmDialogResult;

/******************************************************************************
 * Prototypes
 *****************************************************************************/

MSF_BOOL smaDeleteDialog(MsfWindowHandle windowHandle);
