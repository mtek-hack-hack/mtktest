...
#if !defined(__ROMSA_SUPPORT__)   /* ROM support should be disable whenever DCM is enabled */
#include "dcmgr.h"
#endif
...
typedef unsigned long int DPF_T;
#define DPF_H(dpf)   ((Word16)((dpf)>>16))
#define DPF_L(dpf)   ((Word16)(UWord16)(dpf))
