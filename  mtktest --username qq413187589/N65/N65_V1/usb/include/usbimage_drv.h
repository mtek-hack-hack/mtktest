...
//#define USB_IMAGE_MAX_BUFFERSIZE     				(2*1024)
#define USB_IMAGE_MAX_BUFFERSIZE     				(28*1024)
#define USB_IMAGE_MAX_TX_BUFFERSIZE     			(USB_IMAGE_MAX_BUFFERSIZE/2)
//#define USB_IMAGE_MAX_RX_BUFFERSIZE     			(USB_IMAGE_MAX_BUFFERSIZE/2)

#define USB_IMAGE_MAX_XMLBUFFERSIZE     			(1024)
#define USB_IMAGE_MAX_XMLHREQUESTSIZE     		(1040)
#define USB_IMAGE_MAX_XMLHRSPONSESIZE     		(1008)

#define USB_IMAGE_MAX_OBJECT_INFO   	  			(1024)
/* For start job XML buffer */
#define USB_IMAGE_MAX_START_JOB_XMLBUFFERSIZE    USB_IMAGE_MAX_BUFFERSIZE + USB_IMAGE_MAX_XMLBUFFERSIZE - USB_IMAGE_MAX_OBJECT_INFO

//#define USB_IMAGE_TIMEOUT							150
...
typedef struct {
	LOCAL_PARA_HDR
//	kal_uint8             	*dps_xml_buffer_address; 		/* address of xml packet*/
//	kal_uint32		dps_start_job_xml_buffer_size;
//	kal_uint32		dps_xml_buffer_size;
...
typedef struct
{
	kal_uint8		data_buffer[2][USB_IMAGE_MAX_BUFFERSIZE/2];
}USB_IMAGE_BUFFER;
...
//extern void USB_Image_Start_Timer(void);
...
//extern void USB_Image_Send_Intr(void *addr, kal_uint32 len);
extern void USB_Image_Send_Intr(void);
extern void USB_Image_Cancel_By_Device(void);
extern void USB_Image_Send_Msg(USBIMAGE_MSG_TYPE msg_type, kal_uint32 param1, kal_uint32 param2);
