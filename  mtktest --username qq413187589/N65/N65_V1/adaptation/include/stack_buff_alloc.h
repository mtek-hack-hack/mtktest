...
extern void* get_int_buffer(kal_uint16 size, kal_char* file, kal_uint32 line );
#else
extern void* get_int_buffer(kal_uint32 size, kal_char* file, kal_uint32 line );
#endif
...
#define GET_BUFFER(size, ptr_type, return_ptr, file_name, line) \
        {   \
           return_ptr = (ptr_type)get_int_buffer(size, file_name, line);    \
        }
...
#define GET_BUFFER(size, ptr_type, return_ptr, file_name, line) \
        {   \
            return_ptr = (ptr_type)get_int_buffer(size, NULL, 0);\
        }
