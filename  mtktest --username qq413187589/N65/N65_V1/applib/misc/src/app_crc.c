 ...
 * Description:
 * ------------
 *   This file contains CRC32 functions.
 *
 * Author:
 * -------
 * 
...
const kal_uint32 g_applib_crc_table[256] = 
{
 ...
 *  void
 *****************************************************************************/
kal_uint32 applib_crc_update(kal_uint32 CRCAccum, kal_uint8 *Data_p, kal_uint16 DataBlkSize)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    register kal_uint16 i, j;
    ...
    {
        i = ((kal_uint16) (CRCAccum >> 24) ^ *Data_p++) & 0xff;
