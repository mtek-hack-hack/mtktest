...
extern void kal_internal_release_buffer( void* );
   ...
   void* kal_int_mem_alloc(kal_uint32 alloc_id,kal_uint32 size, char* file_name, int line);
   void kal_int_mem_free( void*    mem_ptr, char* file_name,int line );
#else
