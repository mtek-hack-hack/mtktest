...
extern void MakeCSDForABM(PS8 num, U8 length, U8 callType);
...
#ifdef __SAT__
extern void MakeSATCall(PU8 number);
#endif /* __SAT__ */
...
extern void mmi_gsm_ucm_act_req(U8 op_code, void *act_struct);

#ifdef __CTM_SUPPORT__
extern void mmi_gsm_ctm_open(BOOL ctm_open);
extern pBOOL mmi_gsm_ctm_is_open(void);
extern pBOOL mmi_gsm_ctm_is_on(void);
extern pBOOL mmi_gsm_ctm_is_connected(void);
