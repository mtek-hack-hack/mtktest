...
INC_SCR_RSK_STR,
    ...
    STR_NFY_CALL_CUG,
    STR_NFY_CALL_CTFAC,
    STR_ID_CALL_IS_FORWARDED, /* by Mick, 2006/12/26 */
    STR_ID_CALL_IS_FORWARDED_CALL,	/* by Mick, 2006/12/26 */
    TITLE_SCR_NFY,
    ...
    STR_CALL_ABORTED, STR_CALL_ENDED, STR_DTMF_CONFIRMATION,
    /* MTK amanda add 1229 */
    STR_CM_REDIAL, STR_CM_REDIAL_TIMES, STR_CM_REDIAL_NEXT_ATTEMPT, STR_CM_REDIAL_SEC, STR_CM_REDIAL_MIN,
