...
/*****************************************************************************
 * FUNCTION
 *  PlayCard2ConnectNotice
 * DESCRIPTION
 *  This function is wrapper to Play Card2 Ring Tone
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void PlayCard2ConnectNotice(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    switch (GetConnectNoticeType())
    {
        case MMI_NOTICE_NONE:
            break;
        case MMI_NOTICE_TONE_ONLY:
            MTPNP_PFAL_CC_DoPlayConnetTone();
            break;
        case MMI_NOTICE_VIB_ONLY:
            PlayVibratorOnce();
            break;
...
void PsCBackPlayInternalTone(void *info)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_gsm_alert_ind(GetOutgoingCallHandle(), flag);
}
