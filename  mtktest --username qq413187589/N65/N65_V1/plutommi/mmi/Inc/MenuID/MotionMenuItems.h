...
MENU_ID_MOTION_APP,
    ...
    MENU_ID_MOTION_DICE_EDT_OPT_ROOT,
    MENU_ID_MOTION_DICE_EDT_OPT_DONE,
    MENU_ID_MOTION_DICE_EDT_OPT_CANCEL,
    MENU_ID_MOTION_DICE_EDT_OPT_INPUT,
    MENU_ID_MOTION_DICE_EVENT_VIEW_IMAGE_ROOT,
    MENU_ID_MOTION_DICE_EVENT_VIEW_IMAGE,
    MENU_ID_MOTION_DICE_EVENT_PLAY_VIDEO_ROOT,
    MENU_ID_MOTION_DICE_EVENT_PLAY_VIDEO,
    MENU_ID_MOTION_DICE_EVENT_PLAY_AUDIO_ROOT,
    MENU_ID_MOTION_DICE_EVENT_PLAY_AUDIO,
    MENU_ID_MOTION_DICE_EVENT_FILE_SELECT_ROOT, MENU_ID_MOTION_DICE_EVENT_FILE_SELECT,
    /* DJ Game */
    MENU_ID_MOTION_DJ_APP, MENU_ID_MOTION_DJ_START, MENU_ID_MOTION_DJ_SETTING,
   /******** End of ID ********/
