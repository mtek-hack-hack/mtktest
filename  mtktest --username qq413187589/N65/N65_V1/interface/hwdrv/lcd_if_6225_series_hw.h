 ...
 *
 *******************************************************************************/
#ifndef __LCD_IF_6225_SERIES_HW_H__
#define __LCD_IF_6225_SERIES_HW_H__
...
#include "drv_features.h"
    ...
    #define LCD_PARALLEL1_CONFIG_REG        (LCD_base+0x001C)
      ...
      #define LCD_COLOR_PALETTE0_ADDR       (LCD_base+0xC000)
      #define LCD_CMD_PARAMETER_ADDR        (LCD_base+0xC400)
      #define LCD_CMD_PARAMETER2_ADDR       (LCD_base+0xC480)
      #define LCD_GAMMA_TABLE_ADDR          (LCD_base+0xC500)   
      ...
      #define REG_LCD_ROI_HW_CTRL           *((volatile unsigned int *) (LCD_base+0x0064))// 6225 has this function
      ...
      #define REG_LCD_ROI_BACKGROUND_COLOR  *((volatile unsigned short *) (LCD_base+0x0068))         
      ...
      #define LCD_ROI_WMEM_BUG_BIT                       0x1000
...
/*end of serial interface control*/                                                         
   ...
   /* macros of LCD parallel config register */
      ...
      {\
         *((volatile unsigned int *) (LCD_GAMMA_TABLE_ADDR+(gamma_index<<2))) &= ~(0x3F<<(gamma_table_id*6));\
         *((volatile unsigned int *) (LCD_GAMMA_TABLE_ADDR+(gamma_index<<2)))|=((gamma_value&0x3F)<<(gamma_table_id*6));\
      }
      ...
      #if defined(MT6225)              
         #define CONFIG_LCD_DRIVING_CURRNET(current)        *((volatile unsigned short *) 0x80000704) &= ~0x1F80;\
                                                            *((volatile unsigned short *) 0x80000704) |= ((current_value<<7)|(current_value<<10));
      #else
...
#endif /* (defined(MT6225)||defined(MT6226)||defined(MT6226M)||defined(MT6227)||defined(MT6227D)||defined(MT6226D))   */

#endif //__LCD_IF_6225_SERIES_HW_H__