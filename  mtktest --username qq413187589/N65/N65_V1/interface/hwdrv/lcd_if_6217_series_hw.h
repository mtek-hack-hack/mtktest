 ...
 * Description:
 * ------------
 *   This file is to define LCD HW register in 6217, 6223, 6223P chips.
 *
 * Author:
 * -------
 * -------
 ...
 *
 *******************************************************************************/
#ifndef __LCD_IF_6217_SERIES_HW_H__
#define __LCD_IF_6217_SERIES_HW_H__

#include "kal_release.h"
#include "drv_features.h"


#if (defined(MT6217)||defined(MT6223)||defined(MT6223P))
   ...
   #define LCD_COLOR_PALETTE0_ADDR     (LCD_base+0xC200)
   #define LCD_COLOR_PALETTE1_ADDR     (LCD_base+0xC400)
   #define LCD_CMD_PARAMETER_ADDR      (LCD_base+0xC600)
   ...
   /// bit mapping of LCD serial interface config register
   #define LCD_PARALLEL_BUS_WIDTH_BIT                 0x00002000   
   #define LCD_LAYER_CTRL_SOURCE_AUTO_INC_BIT         0x00008000     /* source address auto increament */
   #define LCD_LAYER_CTRL_DATA_SWAP_BIT               0x00000001      
   #define LCD_SERIAL_CONFIG_13MHZ_CLK                0x8000
   #define LCD_SERIAL_CONFIG_26MHZ_CLK                0x4000
...
/*start of serial interface control*/         
   ...
   #define SET_LCD_PARALLEL1_CE2RD_SETUP_TIME(n)      REG_LCD_PARALLEL1_CONFIG &= ~LCD_PARALLEL_CONFIG_CE2RD_SETUP_TIME_MASK;\
                                                      REG_LCD_PARALLEL1_CONFIG |= (n<<26);
   #define SET_LCD_PARALLEL2_CE2RD_SETUP_TIME(n)      REG_LCD_PARALLEL2_CONFIG &= ~LCD_PARALLEL_CONFIG_CE2RD_SETUP_TIME_MASK;\
                                                      REG_LCD_PARALLEL2_CONFIG |= (n<<26);                                                         
   ...
   #if (defined(MT6217))
      #define SET_LCD_PARALLEL_16BIT_DATA_BUS         REG_LCD_PARALLEL_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL_8BIT_DATA_BUS          REG_LCD_PARALLEL_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL1_16BIT_DATA_BUS        REG_LCD_PARALLEL1_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL1_8BIT_DATA_BUS         REG_LCD_PARALLEL1_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL2_16BIT_DATA_BUS        REG_LCD_PARALLEL2_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL2_8BIT_DATA_BUS         REG_LCD_PARALLEL2_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;
   #elif (defined(MT6223)||defined(MT6223P))          
      #define SET_LCD_PARALLEL_9BIT_DATA_BUS          REG_LCD_PARALLEL_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL_8BIT_DATA_BUS          REG_LCD_PARALLEL_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL1_9BIT_DATA_BUS         REG_LCD_PARALLEL1_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL1_8BIT_DATA_BUS         REG_LCD_PARALLEL1_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL2_9BIT_DATA_BUS         REG_LCD_PARALLEL2_CONFIG &= ~LCD_PARALLEL_BUS_WIDTH_BIT;
      #define SET_LCD_PARALLEL2_8BIT_DATA_BUS         REG_LCD_PARALLEL2_CONFIG |= LCD_PARALLEL_BUS_WIDTH_BIT;                           
   #endif                       
   ...
   #define CONFIG_LCD_DRIVING_CURRNET(current)          *((volatile unsigned short *) 0x80000708) &= ~0xEE00;\
                                                        *((volatile unsigned short *) 0x80000708) |= ((current<<9)|(current<<13));                                                           
#else
   #error not support chip  
#endif /* (defined(MT6217)||defined(MT6223)||defined(MT6223P))*/

#endif //__LCD_IF_6217_SERIES_HW_H__